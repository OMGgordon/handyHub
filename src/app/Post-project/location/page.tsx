    ...
    <div className="min-h-screen bg-[#faf0df]">
      ...
      <div className="flex items-center justify-center py-10">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-black mb-12">Share Details of Your Project</h1>
          
          {/* Location Card */}
          <div className="bg-white rounded-lg p-8 w-[615px] shadow-sm">
            <h2 className="text-1xl font-semibold text-black mb-12">Enter the location of the project</h2>

        ...
        <div className="text-center w-full max-w-2xl">
          ...
          <div className="bg-white rounded-lg p-6 sm:p-8 w-full shadow-sm">
            ...
            <p className="text-xs sm:text-sm text-gray-700 text-center mb-6 sm:mb-8 max-w-[496px] mx-auto px-2">
              Start the conversation and tell your Service Provider what you
              need done. This helps us show you only qualified and available
                ...
                {uploadedImages.length > 0 && (
                  <div className="mt-3 sm:mt-4 flex gap-1 sm:gap-2 flex-wrap max-w-full">
                    {uploadedImages.map((file, index) => (
                      <div
                        key={index}
                        className="text-xs text-gray-600 bg-white px-2 py-1 rounded max-w-[120px] sm:max-w-none truncate"
                      >
                        {file.name}
                      </div>
                    ))}

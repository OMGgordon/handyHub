          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-600">
                Keep your profile up to date to attract more clients and
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <TabsContent value="profile-info" className="p-8">
                  <CardHeader className="px-0 pt-0">
                    ...
                    <p className="text-gray-600">
                      Update your basic profile information and professional
                      details.
                    </p>
                  </CardHeader>
                  ...
                  <CardContent className="px-0 space-y-6">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm text-gray-600 mb-2">
                            Upload a professional photo to build trust with
                            clients
                          </p>
                          <Button
                            variant="outline"
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          updateProfileData("yearsExperience", parseInt(value))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          updateProfileData("about", e.target.value)
                        }
                    ...
                    <div className="flex justify-end pt-4">
                      <Button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="bg-[#fe9f2b] hover:bg-[#e8912a]"
                      >
                  ...
                  <CardContent className="px-0 space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          updateProfileData("pricingNotes", e.target.value)
                        }
                ...
                <TabsContent value="business-details" className="p-8">
                  <CardHeader className="px-0 pt-0">
                    ...
                    <p className="text-gray-600">
                      Showcase your business highlights and availability.
                    </p>
                  </CardHeader>
                  ...
                  <CardContent className="px-0 space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {highlightOptions.map((highlight) => (
                          ...
                          >
                            <Checkbox
                              id={highlight}
                              checked={profileData.highlights.includes(
                                highlight
                              )}
                              onCheckedChange={() =>
                                toggleArrayItem(
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        {Object.entries(profileData.serviceHours).map(
                          ([day, hours]) => (
                            <div
                              key={day}
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {paymentOptions.map((method) => (
                          ...
                          >
                            <Checkbox
                              id={method}
                              checked={profileData.paymentMethods.includes(
                                method
                              )}
                              onCheckedChange={() =>
                                toggleArrayItem(
                ...
                <TabsContent value="portfolio-reviews" className="p-8">
                  <CardHeader className="px-0 pt-0">
                    ...
                    <p className="text-gray-600">
                      Showcase your work and client testimonials.
                    </p>
                  </CardHeader>
                        ...
                        {profileData.portfolioImages.map((image, index) => (
                          <div key={index} className="relative">
                            ...
                            <button
                              onClick={() => {
                                const newImages =
                                  profileData.portfolioImages.filter(
                                    (_, i) => i !== index
                                  );
                    ...
                    <div className="space-y-4">
                      ...
                      {profileData.reviews.length === 0 ? (
                        <div className="text-center py-8 text-gray-500">
                          ...
                          <p>
                            No reviews yet. Complete your first job to start
                            collecting reviews!
                          </p>
                        </div>
                      ) : (
                ...
                <TabsContent value="verification-contact" className="p-8">
                  <CardHeader className="px-0 pt-0">
                    ...
                    <p className="text-gray-600">
                      Verify your credentials and provide contact information.
                    </p>
                  </CardHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateProfileData("serviceArea", e.target.value)
                          }
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              updateProfileData("hasLicense", checked)
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              updateProfileData("hasInsurance", checked)
                            }
                          />
                        ...
                        {profileData.certificates.map((cert, index) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const newCerts =
                                  profileData.certificates.filter(
                                    (_, i) => i !== index
                                  );
